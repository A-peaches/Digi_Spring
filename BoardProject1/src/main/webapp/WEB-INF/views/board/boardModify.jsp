...
<jsp:include page="../loginState2.jsp"></jsp:include>
	...
	<input type="hidden" name="BOARD_NUM" value="${boardDto.BOARD_NUM}">
		...
		placeholder="닉네임을 입력해주세요." value="${boardDto.BOARD_NAME}"/>
		</div>
		<span style="text-align:left;">
		<span class="form-label">제목 :</span> 
		<input type="text" name="BOARD_SUBJECT" class="form-input" 
		placeholder="제목을 작성해주세요." value="${boardDto.BOARD_SUBJECT}"/>
		</span><br>
		<div style="display:flex; flex-direction:column;">
		  ...
		  placeholder="내용을 작성해주세요." >${boardDto.BOARD_CONTENT}</textarea>
		</div>
		<br>
		<span style="text-align:left;">
		</span><br>

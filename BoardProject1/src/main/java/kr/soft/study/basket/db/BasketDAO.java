		...
		try {
			...
			//insert �떆�옉 
				if(ameCnt != 0) {
					...
					cookies = new BasketDTO();
					cookies.setUser_id(user_id);
					cookies.setCookie_name("American Cookie");
					cookies.setCookie_img("resources/img/cookie1.png");
				...
				if (doubleCnt != 0) {
					...
					cookies.setCookie_img("resources/img/cookie2.png");
				...
				if (otmealCnt != 0) {
					...
					cookies.setCookie_img("resources/img/cookie3.png");

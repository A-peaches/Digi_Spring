...
<jsp:include page="../user/loginState.jsp"></jsp:include>
	...
	<form name="List" method ="post" action="basketAdd" onsubmit="return isEmpty()">
	<table class="table table-hover w-50">
		...
		<tr>
			<td><img src="resources/img/cookie1.png" class="img"/></td>
		...
		<tr>
			<td><img src="resources/img/cookie2.png" class="img"/></td>
		...
		<tr>
			<td><img src="resources/img/cookie3.png" class="img"/></td>
			<td>OtmealCookie</td>
			<td>2,600원</td>
			<td>
		...
		<input type=button name=intoCart onclick="window.location.href='./basketView'" value="장바구니 이동"
